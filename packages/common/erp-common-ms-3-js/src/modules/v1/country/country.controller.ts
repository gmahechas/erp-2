...
export const createOneCountry = async (
  data: ICreateCountry,
): Promise<ICountry> => {
...
export const updateOneCountry = async (
  ...
  let result = await Country.findOneAndUpdate(
...
export const deleteOneCountry = async (
  data: IDeleteCountry,
): Promise<ICountry | null> => {
...
export const searchOneCountry = async (
...
export const searchManyCountry = async (
  data: Partial<ISearchCountry>[],
): Promise<ICountry[]> => {

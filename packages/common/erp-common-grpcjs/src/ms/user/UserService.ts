...
export interface UserServiceClient extends grpc.Client {
  CreateOne(
    argument: _user_Create,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (error?: grpc.ServiceError, result?: _user_One__Output) => void,
  ...
  SearchMany(
    ...
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (error?: grpc.ServiceError, result?: _user_Many__Output) => void,
  ): grpc.ClientUnaryCall;
  SearchMany(
    argument: _user_Many,
    metadata: grpc.Metadata,

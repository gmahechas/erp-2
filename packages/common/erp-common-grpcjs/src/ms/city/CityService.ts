...
export interface CityServiceClient extends grpc.Client {
  CreateOne(
    argument: _city_Create,
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (error?: grpc.ServiceError, result?: _city_One__Output) => void,
  ...
  SearchMany(
    ...
    metadata: grpc.Metadata,
    options: grpc.CallOptions,
    callback: (error?: grpc.ServiceError, result?: _city_Many__Output) => void,
  ): grpc.ClientUnaryCall;
  SearchMany(
    argument: _city_Many,
    metadata: grpc.Metadata,

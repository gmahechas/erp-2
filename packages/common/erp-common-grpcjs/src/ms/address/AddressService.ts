...
import type {
  Create as _address_Create,
  Create__Output as _address_Create__Output,
} from '../address/Create';
import type {
  Delete as _address_Delete,
  Delete__Output as _address_Delete__Output,
} from '../address/Delete';
import type {
  Many as _address_Many,
  Many__Output as _address_Many__Output,
} from '../address/Many';
import type {
  One as _address_One,
  One__Output as _address_One__Output,
} from '../address/One';
import type {
  Search as _address_Search,
  Search__Output as _address_Search__Output,
} from '../address/Search';
import type {
  Update as _address_Update,
  Update__Output as _address_Update__Output,
} from '../address/Update';
...
export interface AddressServiceHandlers
...
export interface AddressServiceDefinition extends grpc.ServiceDefinition {
  CreateOne: MethodDefinition<
    _address_Create,
    _address_One,
    _address_Create__Output,
    _address_One__Output
  >;
  DeleteOne: MethodDefinition<
    _address_Delete,
    _address_One,
    _address_Delete__Output,
    _address_One__Output
  >;
  SearchMany: MethodDefinition<
    _address_Many,
    _address_Many,
    _address_Many__Output,
    _address_Many__Output
  >;
  SearchOne: MethodDefinition<
    _address_Search,
    _address_One,
    _address_Search__Output,
    _address_One__Output
  >;
  UpdateOne: MethodDefinition<
    _address_Update,
    _address_One,
    _address_Update__Output,
    _address_One__Output
  >;
}

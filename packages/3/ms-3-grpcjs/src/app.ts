...
const packageDefinition = protoLoader.loadSync(
  path.resolve(__dirname, '../node_modules/@gmahechas/erp-common-grpcjs/src/protos/3/index.proto'),
);
const proto = grpc.loadPackageDefinition(packageDefinition) as unknown as Pick<
  grpcType.ProtoGrpcType,
  'country' | 'estate' | 'city' | 'address'
>;
